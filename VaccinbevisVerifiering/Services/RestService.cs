...
using VaccinbevisVerifiering.Services.CWT;
...
namespace VaccinbevisVerifiering.Services
{
    ...
    public class Constants
    {
        ...
        private static readonly string TestVaccinRuleRestUrl = "https://dgcg-qa.covidbevis.se/tp/apprules/vaccinbevisverifiera.json";
        private static readonly string ProductionVaccinRuleRestUrl = "https://dgcg.covidbevis.se/tp/apprules/vaccinbevisverifiera.json";
